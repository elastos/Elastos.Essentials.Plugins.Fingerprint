cordova.define("cordova-plugin-fingerprint-aio.Fingerprint", function(require, exports, module) {
  ...
  Fingerprint.prototype.authenticateAndSavePassword = function (passwordKey, password, successCallback, errorCallback) {
    cordova.exec(
      successCallback,
      errorCallback,
      "Fingerprint",
      "authenticateAndSavePassword",
      [passwordKey, password]
    );
  };
  
  Fingerprint.prototype.authenticateAndGetPassword = function (passwordKey, successCallback, errorCallback) {
    cordova.exec(
      successCallback,
      errorCallback,
      "Fingerprint",
      "authenticateAndGetPassword",
      [passwordKey]
    );
  };
  
  Fingerprint.prototype.authenticate = function (successCallback, errorCallback) {
    cordova.exec(
      successCallback,
      errorCallback,
      "Fingerprint",
